...
(function () {
    ...
    Ha = function (a) {
      ...
      try {
        if (
          a.constructor &&
          !Ga(a, "constructor") &&
          !Ga(a.constructor.prototype, "isPrototypeOf")
        )
          return !1;
      } catch (c) {
        return !1;
    ...
    f = function (a, b) {
      ...
      for (d in a)
        if (Ga(a, d)) {
          var e = a[d];
          "array" == Fa(e)
            ? ("array" != Fa(c[d]) && (c[d] = []), (c[d] = f(e, c[d])))
            : Ha(e)
            ? (Ha(c[d]) || (c[d] = {}), (c[d] = f(e, c[d])))
            : (c[d] = e);
        }
      return c;
    };
  ...
  function lb(a, b) {
    for (var c = [], d = kb(a), e = 0; e < d.length; e++) {
      ...
      if (!b || -1 !== b.indexOf(h)) {
        ...
        k &&
          ((k = k.split("-")),
          c.push({ id: g.join("."), Ib: 1 * k[0] || 1, eb: 1 * k[1] || 1 }));
      }
    }
    return c;
  }
 ...
 Copyright (c) 2014 Derek Brans, MIT license https://github.com/krux/postscribe/blob/master/LICENSE. Portions derived from simplehtmlparser, which is licensed under the Apache License, Version 2.0 */
  for (
    var mc = "floor ceil round max min abs pow sqrt".split(" "), nc = 0;
    nc < mc.length;
    nc++
  )
      ...
      if (b && c) {
        ...
        for (
          ...
          h && "AW" === h.prefix && !e.adData && 2 <= h.M.length
            ? (e.adData = { ak: h.M[0], cl: h.M[1] })
            : h &&
              "UA" === h.prefix &&
              !e.gaData &&
              (e.gaData = { gaWpid: h.containerId });
        }
        ...
        if (Ad()) {
          ...
          if (l) {
            ...
            for (var w = 0; w < m.length; w++)
              w < v &&
                (d
                  ? Kd(d, m[w], q, { W: r, options: t })
                  : "AW" === a.prefix && a.M[1]
                  ? Ld()
                    ? Kd([a], m[w], q || "US", { W: r, options: t })
                    : Id(a.M[0], a.M[1], m[w], { W: r, options: t })
                  : "UA" === a.prefix &&
                    (Ld()
                      ? Kd([a], m[w], q || "US", { W: r })
                      : Jd(a.containerId, m[w], { W: r })));
          }
        }
    };
  var Pd = new RegExp(
  ...
  var Ud = function (a) {
      ...
      return function (h) {
        ...
        var v = !m || t;
        v ||
          !(0 <= la(l, "sandboxedScripts")) ||
          (c && -1 !== la(c, "sandboxedScripts")) ||
          (v = qa(e, Sd));
        return (g[k] = v);
      };
    },
  ...
  var Vd = {
    Gf: function (a, b) {
      b[fc.ed] &&
        "string" === typeof a &&
        (a = 1 == b[fc.ed] ? a.toLowerCase() : a.toUpperCase());
  ...
  function De(a, b, c, d) {
    ...
    if (h && h.length) {
      ...
      g = De(
        k.index,
        { I: g, S: 1 === k.Nd ? b.terminate : g, terminate: b.terminate },
        c,
        d
      );
    }
  ...
  function Ee(a, b, c, d) {
    ...
    if (m && m.length) {
      var n = m[0],
        p = De(n.index, { I: h, S: k, terminate: l }, c, d);
      if (!p) return null;
      h = p;
      k = 2 === n.Nd ? l : p;
    }
  ...
  var Le = function (a, b) {
    for (var c = [], d = 0; d < Tb.length; d++)
      if (a.cb[d]) {
        ...
        var g = b.add();
        try {
          var h = De(d, { I: g, S: g, terminate: g }, a, d);
          h ? c.push({ te: d, ie: dc(e), Rf: h }) : (Je(d, a), g());
        } catch (l) {
          g();
        }
      }
  ...
  Re.prototype.register = function (a, b) {
    3 !== Xe(this, a).status &&
      ((Xe(this, a).je = b), (Xe(this, a).status = 3), this.flush());
  };
  Re.prototype.push = function (a, b, c, d) {
    ...
    if (
      c &&
      1 === Xe(this, c).status &&
      ((Xe(this, c).status = 2), this.push("require", [], c), !Ad())
    ) {
      var g = encodeURIComponent(c);
      Ma(
        ("http:" != u.location.protocol ? "https:" : "http:") +
  ...
  var ef = function () {
    ...
    ff = function (a) {
      if (void 0 === bf[a.id]) {
        ...
        switch (a.prefix) {
          case "UA":
            b = Oe("gtagua", { trackingId: a.id });
            break;
          case "AW":
            b = Oe("gtagaw", { conversionId: a });
            break;
          case "DC":
            b = Oe("gtagfl", { targetId: a.id });
            break;
          case "GF":
            b = Oe("gtaggf", { conversionId: a });
            break;
          case "G":
            b = Oe("get", { trackingId: a.id, isAutoTag: !0 });
            break;
          case "HA":
            b = Oe("gtagha", { conversionId: a });
            break;
          default:
            return;
        }
        if (!cf) {
          var c = $b("v", { name: "send_to", dataLayerVersion: 2 });
          Qb.push(c);
          cf = ["macro", Qb.length - 1];
        }
        var d = { arg0: cf, arg1: a.id, ignore_case: !1 };
        d[fc.ka] = "_lc";
        Sb.push(d);
  ...
  var kf = {
      ...
      event: function (a) {
        ...
        if (ia(b) && !(3 < a.length)) {
          ...
          if (ia(k) || ka(k)) {
            for (
              var l = k.toString().replace(/\s+/g, "").split(","),
                m = [],
                n = 0;
              n < l.length;
              n++
          ...
          0 < p.length
            ? (d.eventModel[G.wa] = q.join())
            : delete d.eventModel[G.wa];
          return d;
        }
      },
      js: function (a) {
  ...
  var Cf = [],
    ...
    Hf = function (a) {
      ...
      d ||
        ((d = Tc()), (a["gtm.uniqueEventId"] = d), xd("gtm.uniqueEventId", d));
      Pc = c;
      var e = Gf(a);
      Pc = null;
      switch (c) {
  ...
  function Gf(a) {
    ...
    return d.active
      ? Ne(c, b, d.isWhitelisted, a.eventCallback, a.eventTimeout)
        ? !0
        : !1
      : !1;
  }
  ...
  var og = function () {
      for (
        var a = Ia.userAgent + (C.cookie || "") + (C.referrer || ""),
          b = a.length,
          c = u.history.length;
        0 < c;
  ...
  var zg = function () {
    ...
    for (var h = 0; h < a.length; h++) {
      ...
      "1" == k[0] &&
        ...
        k[1] &&
        (g[a[h].Yc] || (g[a[h].Yc] = []),
        g[a[h].Yc].push({ timestamp: k[1], Vf: k[2] }));
    }
    return g;
  };
  function Ag() {
  ...
  var ch = /^\w+$/,
    dh = /^[\w-]+$/,
    eh = /^~?[\w-]+$/,
    fh = { aw: "_aw", dc: "_dc", gf: "_gf", ha: "_ha" };
  function gh(a) {
  ...
  var nh = function (a, b, c, d, e) {
    ...
    qh = function (a) {
      for (
        var b = ["aw", "dc"], c = gh(a && a.prefix), d = {}, e = 0;
        e < b.length;
        e++
      )
        fh[b[e]] && (d[b[e]] = fh[b[e]]);
  ...
  var vi = function (a, b) {
    ...
    zi = function (a, b, c, d) {
      var e = { prefix: a, path: b, domain: c, be: d },
        g = ih();
      jh(g, e);
      qh(e);
    },
          ...
          if (n) {
            ...
            t ||
              sb(
                ...
                c,
                d,
                0 == e ? void 0 : new Date(p + 1e3 * (null == e ? 7776e3 : e)),
                !0
              );
          }
        }
    ...
    Li = function (a) {
      ...
      if (a.any_of && ka(c)) {
        for (var d = 0; d < c.length; d++)
          if (Li({ function: a["function"], arg0: b, arg1: c[d] })) return !0;
        return !1;
      }
      switch (a["function"]) {
        case "_cn":
  ...
  (Y.a.gtagha = ["google"]),
    (function () {
      ...
      function d(h, k, l, m) {
        ...
        ia(k)
          ? (n.Wd = n.Td = k)
          : "number" === typeof k && (n.Wd = n.Td = String(k));
        if (!ka(m) || 0 == m.length) return n;
        var p = m[0];
        if (!Ha(p)) return n;
        ia(p.id)
          ? (n.Vd = p.id)
          : "number" === typeof p.id && (n.Vd = String(p.id));
      ...
      function e(h) {
        ...
        if (k === G.U) {
          var x = t(G.ia) || {};
          q &&
            (ah(x[G.Pa], !!x[G.B]) && Ai(g, r, void 0, v, w),
            zi(r, void 0, v, w));
      ...
      var a = !1,
        ...
        k = function (l) {
          ...
          if (p) {
            var E = x(G.ia) || {};
            y &&
              (ah(E[G.Pa], !!E[G.B]) && Ai(c, z, void 0, B, A),
              zi(z, void 0, B, A));
          ...
          if (!p || (!r && !F))
            if ((!0 === x(G.ld) && (r = !1), !1 !== x(G.N) || r)) {
              ...
              Ad() &&
                ((I.opt_image_generator = function () {
                  return new Image();
                }),
              ...
              !r &&
                x(G.Y) &&
                (I.google_gtag_event_data = { items: x(G.Y), value: x(G.ja) });
              if (r && "purchase" == n) {
              ...
              r &&
                ("boolean" === typeof x(G.gc) && V("vdnc", x(G.gc)),
                V("vdltv", x(G.qd)));
              var Q = !0;
              Q && b.push(I);
            }
        ...
        if (k) {
          ...
          if (Pc === G.U) {
            var v = l(G.ia) || {},
              ...
              x = void 0 === w ? !0 : !!w;
            m &&
              (ah(v[G.Pa], !!v[G.B]) && Ai(d, n, void 0, p, t),
              zi(n, void 0, p, t),
              vh(x, n, void 0, p, t));
  ...
  (Y.a.gtagua = ["google"]),
    (function () {
      var a,
        ...
        g = { cookie_name: 1, cookie_expires: "duration", levels: 1 },
        h = {
          anonymize_ip: 1,
          fatal: 1,
          non_interaction: 1,
        ...
        n = function (v, w, x) {
          ...
          for (var P = wd(v), U = 0; U < P.length; ++U) {
            ...
            e.hasOwnProperty(X)
              ...
              : c.hasOwnProperty(X)
              ? k(c[X], X, Z, B)
              : /^(dimension|metric|content_group)\d+$/.test(X)
              ? k(1, X, Z, z)
              : X === G.R && 0 > la(P, G.nb) && (B.cookieName = Z + "_ga");
          }
          var ca = String(Pc);
          ...
          0 <=
            la(
              ...
              ca
            ) && m(z, "nonInteraction", !0);
          "login" == ca || "sign_up" == ca || "share" == ca
            ? m(y, "eventLabel", vd(G.Le, v))
            : "search" == ca || "view_search_results" == ca
            ? m(y, "eventLabel", vd(G.Re, v))
            : "select_content" == ca && m(y, "eventLabel", vd(G.Ae, v));
          var R = y[G.ia] || {},
            O = R[G.Pa];
          O || (0 != O && R[G.B])
            ? (B.allowLinker = !0)
            : !1 === O && m(B, "useAmpClientId", !1);
        ...
        p = function (v) {
          ...
          var Q = null,
            ...
            K = B(z.He);
          "purchase" == N || "refund" == N
            ? (Q = { action: N, Va: y(), Ga: x(A) })
            : "add_to_cart" == N
            ? (Q = { action: "add", Ga: x(A) })
            : "remove_from_cart" == N
            ? (Q = { action: "remove", Ga: x(A) })
            : "view_item" == N
            ? (Q = { action: "detail", Va: y(E), Ga: x(A) })
            : "view_item_list" == N
            ? (Q = { action: "impressions", fg: x(A) })
            : "view_promotion" == N
            ? (Q = { action: "promo_view", Pc: x(K) })
            : "select_content" == N && K && 0 < K.length
            ? (Q = { action: "promo_click", Pc: x(K) })
            : "select_content" == N
            ? (Q = { action: "click", Va: { list: B(z.Zb) || E }, Ga: x(A) })
            : "begin_checkout" == N || "checkout_progress" == N
            ? (Q = {
                action: "checkout",
                Ga: x(A),
                Va: {
        ...
        q = function (v, w) {
          ...
          t[v] = f(w);
          if (!x) return !1;
          for (var y in w) if (w.hasOwnProperty(y) && w[y] !== x[y]) return !0;
          for (var z in x) if (x.hasOwnProperty(z) && x[z] !== w[z]) return !0;
          return !1;
        },
        r = function (v) {
          ...
          if (ha(y)) {
            var z = "gtag_" + w.split("-").join("_"),
              ...
              E = function () {
                if (Ad()) {
                  ...
                  var Q = vd(G.Me, w);
                  Q &&
                    (B("require", Q, { dataLayer: "dataLayer" }),
                    B("require", "render"));
                }
              },
            ...
            if (I && I[G.B]) {
              ...
              te(
                z + ".",
                I[G.B],
                void 0 === S ? !!I.use_anchor : "fragment" === S,
                !!I[G.Qa]
              );
            }
            var T = function (Q, N, K) {
              ...
              V = Pc;
            V == G.Yb
              ? (E(), B("send", "pageview", F.ca))
              : V == G.U
              ? (E(), Md(w), 0 != F.sendPageView && B("send", "pageview", F.ca))
              : "screen_view" == V
              ? B("send", "screenview", F.ca)
              : "timing_complete" == V
              ? (T("timingCategory", F.eventCategory, !0),
                T("timingVar", F.name, !0),
                T("timingValue", sa(F.value)),
                void 0 !== F.eventLabel && T("timingLabel", F.eventLabel, !0),
                B("send", "timing", F.ca))
              : "exception" == V
              ? B("send", "exception", F.ca)
              : "optimize.callback" != V &&
                (0 <=
                  la(
